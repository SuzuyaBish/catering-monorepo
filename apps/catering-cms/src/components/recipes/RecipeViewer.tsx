...
export default function RecipeViewer() {
  ...
  const recipeImage = useRecipeStore().recipeImage
  return (
              ...
              <div>
                ...
                {recipe?.reviews?.length > 0 && (
                  <>
                      ...
                      {[0, 1, 2, 3, 4].map((rating) => (
                        <StarIcon
                          ...
                          className={classNames(
                            getReviewAverage(recipe) > rating
                              ? "text-yellow-400"
                              : "text-gray-300",
                    ...
                    <p className="sr-only">
                      {getReviewAverage(recipe)} out of 5 stars
                    </p>
                  </>
                )}
              </div>
          ...
          <div className="mx-auto mt-16 w-full max-w-2xl lg:col-span-4 lg:mt-0 lg:max-w-none">
            <Tab.Group as="div">
              ...
              <Tab.Panels as={Fragment}>
                <Tab.Panel className="pt-10 text-sm text-gray-500">
                  <h3 className="sr-only">Recipe Ingredients</h3>

                  <div className="grid grid-cols-2">
                    {recipe?.ingredients?.map((ingredient) => (
                      <Fragment key={ingredient}>
                        <li className="mt-3 font-medium text-gray-900">
                          {ingredient}
                        </li>
                      </Fragment>
                    ))}
                ...
                <Tab.Panel className="pt-10 text-sm text-gray-500">
                  <h3 className="sr-only">Recipe Instructions</h3>
